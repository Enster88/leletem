...
export default async function handler(req, res) {
  ...
  if (userId) {
    // Bejelentkezett user – ellenőrzés Supabase-ből
    ...
    if (!user) {
      // Első alkalom – létrehozzuk a usert
    ...
    // Számláló frissítése ha nem prémium
    if (!user.is_premium) {
    ...
    // Nem bejelentkezett – anonymous limit (session alapú, egyszer próbálhat)
